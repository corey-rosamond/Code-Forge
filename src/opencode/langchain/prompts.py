"""System prompt generation for OpenCode agent."""
...
def get_system_prompt(
    ...
    """
    Generate comprehensive system prompt for the OpenCode agent.
    ...
    return f"""You are OpenCode, an AI-powered CLI development assistant. You help users with software engineering tasks including writing code, debugging, explaining code, running commands, and managing files.
...
def get_minimal_prompt(tool_names: list[str]) -> str:
    ...
    """
    return f"""You are OpenCode, an AI assistant with tools for file operations and command execution.
