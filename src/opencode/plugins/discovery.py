...
class PluginDiscovery:
    ...
    - User plugin directory (~/.opencode/plugins/)
    ...
    def __init__(
        ...
        Args:
            user_dir: User plugin directory. Default ~/.opencode/plugins
            project_dir: Project plugin directory. Default .opencode/plugins
