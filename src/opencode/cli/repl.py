"""REPL (Read-Eval-Print Loop) for OpenCode CLI.
...
from opencode.cli.themes import Theme, ThemeRegistry
...
class OpenCodeREPL:
    ...
    def _show_welcome(self) -> None:
        ...
        cwd = Path.cwd()
        welcome = f"""
[bold {self._theme.accent}]OpenCode[/bold {self._theme.accent}] v{__version__}
