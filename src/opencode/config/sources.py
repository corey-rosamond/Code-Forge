"""Configuration sources for OpenCode.
...
from opencode.core import ConfigError, get_logger
...
class EnvironmentSource(IConfigSource):
    ...
    MAPPINGS: ClassVar[dict[str, str | tuple[str, str]]] = {
        ...
        "OPENCODE_MODEL": ("model", "default"),
        "OPENCODE_MAX_TOKENS": ("model", "max_tokens"),
        "OPENCODE_TEMPERATURE": ("model", "temperature"),
        "OPENCODE_THEME": ("display", "theme"),
        "OPENCODE_VIM_MODE": ("display", "vim_mode"),
        "OPENCODE_STREAMING": ("display", "streaming"),
    }
