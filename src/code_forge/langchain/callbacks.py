...
if TYPE_CHECKING:
    from code_forge.llm.models import TokenUsage


@dataclass
class CodeForgeCallbackHandler(BaseCallbackHandler):
    """
...
@dataclass
class TokenTrackingCallback(CodeForgeCallbackHandler):
    """
...
@dataclass
class LoggingCallback(CodeForgeCallbackHandler):
    """
    ...
    logger: logging.Logger = field(
        default_factory=lambda: logging.getLogger("code_forge.langchain")
    )
...
@dataclass
class StreamingCallback(CodeForgeCallbackHandler):
    """
...
@dataclass
class CompositeCallback(CodeForgeCallbackHandler):
    """
