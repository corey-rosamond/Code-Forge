...
if TYPE_CHECKING:
    from code_forge.commands.base import Command
...
class PluginMetadata:
    ...
    Attributes:
        ...
        forge_version: Optional version constraint (e.g., ">=1.0.0").
    """
...
class Plugin(ABC):
    ...
    Plugins extend Code-Forge by providing tools, commands, hooks,
