"""Exception hierarchy for Code-Forge."""
...
class ConfigError(CodeForgeError):
    """Configuration-related errors."""

    pass


class ToolError(CodeForgeError):
...
class ProviderError(CodeForgeError):
...
class PermissionDeniedError(CodeForgeError):
...
class SessionError(CodeForgeError):
