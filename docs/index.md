...
Welcome to OpenCode, an AI-powered coding assistant that provides access to 400+ models via OpenRouter API.

## What is OpenCode?

OpenCode is a command-line interface (CLI) tool that brings AI assistance directly to your terminal. It's designed to help developers with:
...
- Report issues at [GitHub Issues](https://github.com/anthropics/opencode/issues)
