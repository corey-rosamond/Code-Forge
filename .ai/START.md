...
The project has 22 phases with complete planning documentation. Phases 1.1-1.3, 2.1-2.3, 3.1-3.2, 4.1-4.2, 5.1-5.2, and 6.1 are complete.
...
**Phase Name:** Operating Modes

**Phase Directory:** `.ai/phase/6.2/`
...
Read all files in the current phase directory (`.ai/phase/6.2/`):
